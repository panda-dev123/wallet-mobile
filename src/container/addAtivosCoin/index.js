...
import { addAtivos, addPrepaidAccount } from '../../actions';
...
class AddAtivosCoin extends Component {
	state = {
		colors: [
			'#F44336',
			'#E91E63',
					...
					<ScrollView style={{ flex: 1 }}>
						<Form style={{ padding: 20 }}>
							...
							>
								...
								>
									{Database.getAtivosCurrenciesAvailable().map(
...
export default connect(mapStateToProps, { addAtivos })(AddAtivosCoin);
