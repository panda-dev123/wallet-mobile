...
class AddPrePaid extends Component {
	state = {
		colors: [
			'#F44336',
			'#E91E63',
				...
				<ScrollView style={{ flex: 1 }}>
					<Form style={{ padding: 20 }}>
						...
						>
							...
							>
								{Database.getPrepaidCurrenciesAvailable().map(
...
export default connect(mapStateToProps, { addPrepaidAccount })(AddPrePaid);
